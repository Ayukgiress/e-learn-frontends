          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="password"bg-gradient-to-br from-blue-600 to-blue-800 
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="••••••••"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none">
